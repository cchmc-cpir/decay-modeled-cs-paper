...
# Set up subplot
plt.figure()
fig, axes = plt.subplots(nrows=6, ncols=3, figsize=(10, 17))
fig.suptitle('Image reconstructions')

ax = axes[0, 0]
im = ax.imshow(x, cmap="gray", vmin=0, vmax=1)
ax.plot((0, image_size), (line_idx, line_idx), 'm-')
ax.set_title('object')
# fig.colorbar(im, ax=ax)
ax.axis('off')
ax = axes[0, 1]
ax.plot(lineprof(norm_img(x)), 'w', linewidth=1, label='$\hat{x}$')
...
ax.axis('off')
ax = axes[0, 2]
ax.plot(lineprof(norm_img(x))-lineprof(norm_img(x)), 'w', linewidth=1)
ax.set_xlim([0, image_size])
ax.set_ylim([-0.5, 0.5])
ax.set_title('$\hat{x} - \hat{x}$')
ax.axis('off')


ax = axes[1, 0]
im = ax.imshow(img_nufft, cmap="gray")
ax.set_title(r'$(DF)^H(y)$')
# fig.colorbar(im, ax=ax)
ax.axis('off')
ax = axes[1, 1]
ax.plot(lineprof(norm_img(x)), 'w', linewidth=1, label='$\hat{x}$')
ax.plot(lineprof(norm_img(img_nufft)), 'g', linewidth=1, label='$(DF)^H(y)$')
ax.legend(loc='upper right', fontsize=10)
ax.set_title('line profile')
ax.set_xlim([0, image_size])
ax.set_ylim([0, 1])
ax.axis('off')
ax = axes[1, 2]
ax.plot(lineprof(norm_img(x))-lineprof(norm_img(img_nufft)), 'g', linewidth=1)
ax.set_xlim([0, image_size])
ax.set_ylim([-0.5, 0.5])
ax.set_title('$\hat{x} - (DF)^H(y)$')
ax.axis('off')


ax = axes[2, 0]
im = ax.imshow(img_nufft_norm, cmap="gray")
ax.set_title(r'$(DF)^H(y_n)$')
# fig.colorbar(im, ax=ax)
ax.axis('off')
ax = axes[2, 1]
ax.plot(lineprof(norm_img(x)), 'w', linewidth=1, label='$\hat{x}$')
ax.plot(lineprof(norm_img(img_nufft_norm)),
        'g', linewidth=1, label='$(DF)^H(y_n)$')
ax.legend(loc='upper right', fontsize=10)
ax.set_title('line profile')
ax.set_xlim([0, image_size])
ax.set_ylim([0, 1])
ax.axis('off')
ax = axes[2, 2]
ax.plot(lineprof(norm_img(x))-lineprof(norm_img(img_nufft_norm)), 'g', linewidth=1)
ax.set_xlim([0, image_size])
ax.set_ylim([-0.5, 0.5])
ax.set_title('$\hat{x} - (DF)^H(y_n)$')
ax.axis('off')


ax = axes[3, 0]
im = ax.imshow(img_cg, cmap="gray")
ax.set_title(r'$||Fx-y||^2_2$')
# fig.colorbar(im, ax=ax)
ax.axis('off')
ax = axes[3, 1]
ax.plot(lineprof(norm_img(x)), 'w', linewidth=1, label='$\hat{x}$')
ax.plot(lineprof(norm_img(img_cg)), 'g', linewidth=1, label='$||Fx-y||^2_2$')
ax.legend(loc='upper right', fontsize=10)
ax.set_title('line profile')
ax.set_xlim([0, image_size])
ax.set_ylim([0, 1])
ax.axis('off')
ax = axes[3, 2]
ax.plot(lineprof(norm_img(x))-lineprof(norm_img(img_cg)), 'g', linewidth=1)
ax.set_xlim([0, image_size])
ax.set_ylim([-0.5, 0.5])
ax.set_title('$\hat{x} - ||Fx-y||^2_2$')
ax.axis('off')


ax = axes[4, 0]
im = ax.imshow(img_cg_normalized, cmap="gray")
ax.set_title(r'$||Fx-y_n||^2_2$')
# fig.colorbar(im, ax=ax)
ax.axis('off')
ax = axes[4, 1]
ax.plot(lineprof(norm_img(x)), 'w', linewidth=1, label='$\hat{x}$')
ax.plot(lineprof(norm_img(img_cg_normalized)),
        'g', linewidth=1, label='$||Fx-y_n||^2_2$')
ax.legend(loc='upper right', fontsize=10)
ax.set_title('line profile')
ax.set_xlim([0, image_size])
ax.set_ylim([0, 1])
ax.axis('off')
ax = axes[4, 2]
ax.plot(lineprof(norm_img(x)) -
        lineprof(norm_img(img_cg_normalized)), 'g', linewidth=1)
ax.set_xlim([0, image_size])
ax.set_ylim([-0.5, 0.5])
ax.set_title('$\hat{x} - ||Fx-y_n||^2_2$')
ax.axis('off')


ax = axes[5, 0]
im = ax.imshow(img_cg_model, cmap="gray")
ax.set_title(r'$||RFx-y||^2_2$')
# fig.colorbar(im, ax=ax)
ax.axis('off')
ax = axes[5, 1]
ax.plot(lineprof(norm_img(x)), 'w', linewidth=1, label='$\hat{x}$')
ax.plot(lineprof(norm_img(img_cg_model)), 'g',
        linewidth=1, label='$||RFx-y||^2_2$')
ax.legend(loc='upper right', fontsize=10)
ax.set_title('line profile')
ax.set_xlim([0, image_size])
ax.set_ylim([0, 1])
ax.axis('off')
ax = axes[5, 2]
ax.plot(lineprof(norm_img(x))-lineprof(norm_img(img_cg_model)), 'g', linewidth=1)
ax.set_xlim([0, image_size])
ax.set_ylim([-0.5, 0.5])
ax.set_title('$\hat{x} - ||RFx-y||^2_2$')
ax.axis('off')
...
ax = axes[1, 1]
ax.plot(lineprof(norm_img(x)), 'w', linewidth=1, label='$\hat{x}$')
ax.plot(lineprof(norm_img(img_nufft)), 'b', linewidth=1, label='$(DF)^H(y)$')
ax.legend(loc='upper right', fontsize=10)
# ax.set_title('line profile')
ax.set_xlim([0, image_size])
ax.set_ylim([0, 1])
...
ax = axes[0, 2]
im = ax.imshow(img_cg, cmap="gray")
ax.set_title(r'$\underset{x}{\operatorname{\min}}||Fx-y||^2_2$')
# fig.colorbar(im, ax=ax)
ax.axis('off')
ax = axes[0, 3]
ax.plot(lineprof(norm_img(x)), 'w', linewidth=1, label='$\hat{x}$')
ax.plot(lineprof(norm_img(img_cg)), 'c', linewidth=1,
        label=r'$\underset{x}{\operatorname{\min}}||Fx-y||^2_2$')
ax.legend(loc='upper right', fontsize=10)
# ax.set_title('line profile')
ax.set_xlim([0, image_size])
ax.set_ylim([0, 1])
...
ax = axes[1, 2]
im = ax.imshow(img_cg_normalized, cmap="gray")
ax.set_title(r'$\underset{x}{\operatorname{\min}}||Fx-y_n||^2_2$')
# fig.colorbar(im, ax=ax)
ax.axis('off')
ax = axes[1, 3]
ax.plot(lineprof(norm_img(x)), 'w', linewidth=1, label='$\hat{x}$')
ax.plot(lineprof(norm_img(img_cg_normalized)), 'm', linewidth=1,
        label=r'$\underset{x}{\operatorname{\min}}||Fx-y_n||^2_2$')
ax.legend(loc='upper right', fontsize=10)
# ax.set_title('line profile')
ax.set_xlim([0, image_size])
ax.set_ylim([0, 1])
...
ax = axes[2, 2]
im = ax.imshow(img_cg_model, cmap="gray")
ax.set_title(r'$\underset{x}{\operatorname{\min}}||RFx-y||^2_2$')
# fig.colorbar(im, ax=ax)
ax.axis('off')
ax = axes[2, 3]
ax.plot(lineprof(norm_img(x)), 'w', linewidth=1, label='$\hat{x}$')
ax.plot(lineprof(norm_img(img_cg_model)), 'gold', linewidth=1,
        label=r'$\underset{x}{\operatorname{\min}}||RFx-y||^2_2$')
ax.legend(loc='upper right', fontsize=10)
# ax.set_title('line profile')
ax.set_xlim([0, image_size])
ax.set_ylim([0, 1])
...
ax.axis('off')
ax = axes[0, 1]
im = ax.imshow(img_mask, cmap="gray", vmin=0, vmax=1)
ax.plot((0, image_size), (line_idx, line_idx), 'm-')
ax.set_title('mask')
fig.colorbar(im, ax=ax)
ax.axis('off')
ax = axes[0, 2]
ax.plot(lineprof(norm_img(x)), 'w', linewidth=1, label=r'$\hat{x}$')
ax.legend(loc='upper right', fontsize=10)
ax.set_title('line profile')
ax.set_xlim([0, image_size])
ax.set_ylim([0, 1])
...
ax = axes[1, 2]
ax.plot(lineprof(norm_img(x)), 'w', linewidth=1, label='$\hat{x}$')
ax.plot(lineprof(norm_img(img_cg)), 'g', linewidth=1, label=r'$||Fx-y||^2_2$')
ax.legend(loc='upper right', fontsize=10)
ax.set_title('line profile')
ax.set_xlim([0, image_size])
ax.set_ylim([0, 1])
...
ax.plot(lineprof(norm_img(x)), 'w', linewidth=1, label='$\hat{x}$')
ax.plot(lineprof(norm_img(img_cg_normalized)),
        'r', linewidth=1, label=r'$||Fx-y_n||^2_2$')
ax.legend(loc='upper right', fontsize=10)
ax.set_title('line profile')
ax.set_xlim([0, image_size])
ax.set_ylim([0, 1])
ax = axes[2, 3]
ax.plot(lineprof(norm_img(x)) -
        lineprof(norm_img(img_cg_normalized)), 'r', linewidth=1)
ax.set_xlim([0, image_size])
ax.set_ylim([-0.5, 0.5])
ax.set_title(r'$\hat{x} - ||Fx-y_n||^2_2$')

ax = axes[3, 0]
im = ax.imshow(img_nufft_model, cmap="gray")
ax.set_title(r'$(RDF)^H(y)$')
fig.colorbar(im, ax=ax)
ax.axis('off')
ax = axes[3, 1]
im = ax.imshow(img_cg_model, cmap="gray")
...
ax = axes[3, 2]
ax.plot(lineprof(norm_img(x)), 'w', linewidth=1, label='$\hat{x}$')
ax.plot(lineprof(norm_img(img_cg_model)), 'y',
        linewidth=1, label=r'$||RFx-y||^2_2$')
ax.legend(loc='upper right', fontsize=10)
ax.set_title('line profile')
ax.set_xlim([0, image_size])
ax.set_ylim([0, 1])
ax = axes[3, 3]
ax.plot(lineprof(norm_img(x))-lineprof(norm_img(img_cg_model)), 'y', linewidth=1)
ax.set_xlim([0, image_size])
ax.set_ylim([-0.5, 0.5])
ax.set_title(r'$\hat{x} - ||RFx-y||^2_2$')


# %% Summary plots for paper with CS
